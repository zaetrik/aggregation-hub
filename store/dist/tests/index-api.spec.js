...
describe("Index API", () => {
    ...
    it("creates an index", () => __awaiter(this, void 0, void 0, function* () {
        yield api.delete("/index/delete/1");
        const response = yield api.post("/index/create/1");
        expect(response.body.status).toEqual(200);
        expect(response.body.index).toEqual("module-1");
    }));
    it("return 304 when index already exists", () => __awaiter(this, void 0, void 0, function* () {
        yield api.post("/index/create/1");
        const response = yield api.post("/index/create/1");
        expect(response.status).toEqual(304);
    }));
    it("gets count of documents in index", () => __awaiter(this, void 0, void 0, function* () {
        const response = yield api.get("/index/count/1");
        expect(response.body.status).toEqual(200);
        expect(Number(response.body.count)).toEqual(0);
    }));
    it("gets mapping from index", () => __awaiter(this, void 0, void 0, function* () {
