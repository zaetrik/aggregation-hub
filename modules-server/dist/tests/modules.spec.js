...
describe("Modules API", () => {
    ...
    it("adds a module", () => __awaiter(this, void 0, void 0, function* () {
    ...
    it("gets all modules", () => __awaiter(this, void 0, void 0, function* () {
        const response = yield api.get("/modules");
        expect(response.body.status).toEqual(200);
        expect(response.body.modules).toBeDefined();
    }));
    it("gets modules by name", () => __awaiter(this, void 0, void 0, function* () {
        const response = yield api.get("/modules/test");
        expect(response.body.status).toEqual(200);
        expect(response.body.modules).toBeDefined();
    }));
    it("gets a module with moduleId", () => __awaiter(this, void 0, void 0, function* () {
        const response = yield api.get("/modules/id/1");
        expect(response.body.status).toEqual(200);
        expect(response.body.modules).toBeDefined();
    }));
    it("updates a module config", () => __awaiter(this, void 0, void 0, function* () {
    ...
    it("gets module route settings from module", () => __awaiter(this, void 0, void 0, function* () {
        const response = yield api.get("/modules/id/1/routeSettings");
        expect(response.body.status).toEqual(200);
        expect(response.body.routeSettings).toBeDefined();
    }));
    it("updates module route settings from module", () => __awaiter(this, void 0, void 0, function* () {
        const response = yield api.post("/modules/id/1/routeSettings").send({
            moduleRouteSettings: { testRoute: {} }
        });
        expect(response.body.status).toEqual(200);
    }));
    it("deletes a module", () => __awaiter(this, void 0, void 0, function* () {
