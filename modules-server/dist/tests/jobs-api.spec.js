...
describe("Jobs API", () => {
    ...
    it("adds a job", () => __awaiter(this, void 0, void 0, function* () {
    ...
    it("gets all jobs", () => __awaiter(this, void 0, void 0, function* () {
        const response = yield api.get("/jobs");
        expect(response.body.status).toEqual(200);
        expect(response.body.jobs).toBeDefined();
    }));
    it("gets a job with moduleId", () => __awaiter(this, void 0, void 0, function* () {
        const response = yield api.get("/jobs/id/1");
        expect(response.body.status).toEqual(200);
        expect(response.body.jobs).toBeDefined();
    }));
    it("updates a job", () => __awaiter(this, void 0, void 0, function* () {
    ...
    it("deletes a job", () => __awaiter(this, void 0, void 0, function* () {
